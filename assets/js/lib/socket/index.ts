...
const socket = user_id ? Socket() : null;
const feed_channel = Application.is_authenticated()
  ? Feed.init(socket, user_id)
  : null;
const user_channel = Application.is_authenticated()
  ? User.init(socket, user_id)
  : null;
