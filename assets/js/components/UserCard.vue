	...
	<div v-if="user" class="profile" :data-layout-type="type">
		...
		<div class="profile-stats">
			<ul v-if="$store.getters.user">
				<li v-if="!isAuthUser">
					<button v-if="user.following" @click.prevent="unfollow" @mouseover="mouseInUnfollow = true" @mouseleave="mouseInUnfollow = false" class="button" data-button-size="medium" data-button-font="big" data-button-unmask :data-button-dark="!mouseInUnfollow" :data-button-important="mouseInUnfollow">
						<template>
					...
					<button v-else @click.prevent="follow" class="button" data-button-size="medium" data-button-font="big" data-button-unmask data-button-success>
						<i class="fas fa-user-plus"></i>&nbsp;Seguir
					</button>
				</li>
				<li v-if="isAuthUser">
					<router-link to="/settings/appearance" class="button" data-button-size="medium" data-button-font="big" data-button-unmask data-button-dark>
						<i class="fas fa-cog"></i>&nbsp;Cambiar apariencia
					</router-link>
				</li>
				<li v-if="!isAuthUser">
					<button v-if='user.blocked' @click.prevent='unblock' class="button" data-button-size="medium" data-button-font="big" data-button-unmask data-button-dark>
						<i class="zmdi zmdi-check"></i>&nbsp;Desbloquear
					</button>
					<button v-else class="button" @click.prevent='block' data-button-size="medium" data-button-font="big" data-button-unmask data-button-dark>
