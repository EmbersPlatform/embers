<template>
  <div
    class="image-uploader tool"
    :class="{'url-uploader' : (askForUrl && !askForSource), 'renderbox' : uploading}"
    :data-renderbox-message="[(isImporting) ? 'Importando imagen...' : 'Subiendo imagen...']"
  >
