defmodule EmbersWeb.UserAuthTest do
  use EmbersWeb.ConnCase, async: true

  alias Embers.Accounts
  alias EmbersWeb.UserAuth
  import Embers.AccountsFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, EmbersWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      EmbersWeb.Endpoint.subscribe(live_socket_id)
