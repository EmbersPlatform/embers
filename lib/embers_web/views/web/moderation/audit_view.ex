defmodule EmbersWeb.Web.Moderation.AuditView do
  @moduledoc false
  ...
  defp format_detail(audit, %{action: "in_post"}) do
    {:safe, link} = link(audit.source, to: "/post/#{audit.source}", target: "_blank")
    "En el post #{link}"
  end
